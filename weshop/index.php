	...
	<body>
		...
		<div id="container">
				...
				<div id="menu">
					<div id="user">
						<?php
							if($user_id){
								echo "Hi <b>$nama</b>,
									  <a href='".BASE_URL."index.php?page=my_profile&module=pesanan&action=list'>Profil saya</a>
									  <a href='".BASE_URL."logout.php'>Keluar</a>";
							}else{
								echo "<a href='".BASE_URL."index.php?page=login'>Masuk</a>
			...
			<div id="footer">
				...
				<a href="https://api.whatsapp.com/send?phone=628972867559&text=Saya%20tertarik%20dengan%20produk%20anda">
					<img src="<?php echo BASE_URL."images/wa.png"; ?>"/>
				</a>
				<p>BelanjaPangan.id</p>
			</div>
